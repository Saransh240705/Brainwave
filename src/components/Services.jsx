                    ...
                    <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                        <div className='relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden'>
                            <div className='absolute inset-0'>
                                <img className='h-full w-full object-cover' width={630} height={750} alt='robot' src={service2} />
                            </div>
                        ...
                        <div className='p-4 bg-n-7 rounded-xl overflow-hidden lg:min-h-[45rem]'>
                            <div className='py-12 px-4 xl:px-8'>
                                ...
                                <ul className='flex items-center justify-between'>
                                    {brainwaveServicesIcons.map((item,index) => (
                                        <li className={`flex items-center rounded-xl justify-center ${index === 2 ? 'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient md:w-[4.5rem] md:h-[4.5rem]' : 'flex w-10 h-10 bg-n-6 md:w-15 md:h-15'} `}>
